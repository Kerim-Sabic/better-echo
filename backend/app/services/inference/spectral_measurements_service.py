...
def rel_spectral_upload_path(path: Optional[str]) -> Optional[str]:
    if not path:
        return None
    try:
...
def run_spectral_measurements(
    *,
    ...
    derived_result_type = spectral_measurements_result_type(model_weights)
    existing = (
    ...
    payload: Dict[str, Any] = {
        "outputfile": rel_spectral_upload_path(result.get("output_file_image")),
        "model_weights": model_weights,
