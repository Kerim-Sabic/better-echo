...
They allow pull request authors and reviewers to "Preview" the Horalix Viewer as if
...
The DEPLOY workflow deploys the Horalix Viewer when changes are merged to master.
