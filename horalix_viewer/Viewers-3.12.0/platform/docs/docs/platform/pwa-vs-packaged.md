...
It's important to know that the Horalix Viewer project provides two different build
processes:
...
The Horalix Viewer is maintained as a [monorepo][monorepo]. We use WebPack to build
