...
title: Horalix Viewer Test Coverage
summary: Information about the automated testing infrastructure for the Horalix Viewer, with a focus on Playwright tests and access to the latest test coverage reports, which help ensure reliability and quality of the codebase.
---
