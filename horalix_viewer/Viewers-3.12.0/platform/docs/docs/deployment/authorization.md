...
summary: Guide to configuring OpenID-Connect authentication in Horalix Viewer, including setup of authorization flows, token handling, and implementation details for securing access to medical imaging data.
---

# Authorization and Authentication
The Horalix Viewer can be configured to work with authorization servers that support one or more of the OpenID-Connect authorization flows. The Viewer finds it's OpenID-Connect settings on the oidc configuration key. You can set these values in your configuration files. For instance you can take a look at our
