...
Follow these steps to set up Azure as a DICOM datasource for the Horalix Viewer.
...
1. Save the above configurations in your Horalix Viewer configuration file.
2. Run the viewer:
