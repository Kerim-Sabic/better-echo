---
id: index
title: Horalix Viewer FAQ
summary: Comprehensive list of frequently asked questions about the Horalix Viewer, covering common inquiries about reporting bugs, requesting features, academic collaborations, regulatory status, and obtaining demo studies.
---
...
## Does The Horalix Viewer have [510(k) Clearance][501k-clearance] from the U.S. F.D.A or [CE Marking][ce-marking] from the European Commission?

**NO.** The Horalix Viewer is **NOT** F.D.A. cleared or CE Marked. It is the users'
...
## Is there a DICOM Conformance Statement for the Horalix Viewer?
...
## Is The Horalix Viewer [HIPAA][hipaa-def] Compliant?

**NO.** The Horalix Viewer **DOES NOT** fulfill all of the criteria to become HIPAA
Compliant. It is the users' responsibility to ensure compliance with applicable
rules and regulations.

## Could you provide me with a particular study from the Horalix Viewer Demo?
