...
summary: Comprehensive guide to deploying the Horalix Viewer as a standalone web application or embedded iframe, covering data source configuration, security considerations, and various deployment options with examples for different hosting environments.
---

# Deployment

The Horalix Viewer can be served as a stand-alone PWA ([progressive web
...
Deploying the Horalix Viewer as a stand-alone web application provides many
...
At the end of the day, a production Horalix Viewer instance is a collection of
...
build the Horalix Viewer in our
...
The Horalix Viewer is able to connect to any data source that implements the [DICOM
...
If you have an existing archive and intend to host the Horalix Viewer at the same
...
#### What if I intend to host the Horalix Viewer at a different domain?
...
The Horalix Viewer can be configured to work with authorization servers that
