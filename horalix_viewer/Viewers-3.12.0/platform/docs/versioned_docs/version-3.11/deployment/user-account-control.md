...
- Hosted under the route /ohif-viewer, which serves the static assets of the Horalix Viewer.
...
- `user: viewer password: viewer` - Has access to the Horalix Viewer but not the pacs-admin
- `user: pacsadmin password: pacsadmin` - Has access to both the pacs-admin for uploading and the Horalix Viewer
