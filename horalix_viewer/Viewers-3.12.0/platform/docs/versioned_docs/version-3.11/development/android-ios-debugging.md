...
summary: Comprehensive guide for debugging Horalix Viewer on mobile devices, covering setup of Android and iOS emulators, step-by-step instructions for connecting Chrome DevTools and Safari Web Inspector, and video tutorials demonstrating the debugging workflow.
---
...
4. **Open a Browser on the Emulator:**
   ...
   - Navigate to the Horalix Viewer URL to view the application. The URL will be 10.0.2.2:3000, you can read more about it [here](https://developer.android.com/studio/run/emulator-networking).
...
5. **Happy Debugging!:**
   - You can now use the Safari Web Inspector to inspect elements, debug JavaScript, and view logs for the Horalix Viewer on the iOS simulator.
