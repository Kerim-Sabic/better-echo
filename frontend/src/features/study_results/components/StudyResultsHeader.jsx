...
export default function StudyResultsHeader({
  navigateBack,
  studyUID,
  ...
  const stateLabel = formatStateLabel(panEchoEchoprimeState, isPolling);
  const stateClassName = statusClasses(panEchoEchoprimeState, isPolling);
