...
import { getPanechoEchoprimeCombinedResults } from "../../../api/CombinedResultsApi";
...
export function useCombinedResultsQuery(
    ...
    return useQuery({
        ...
        // one-shot fetch
        queryFn: () => getPanechoEchoprimeCombinedResults(studyUid),
        ...
        select: (response) => {
            ...
            const results = isComplete ? response.data.panecho_echoprime_results : null;
